...
const inputClass =
  "mt-1 w-full rounded-md border border-[--color-aude-stone] bg-white px-3 py-2 text-sm outline-none transition focus:border-[--color-aude-petrol]";
    ...
    <div className="mx-auto max-w-lg">
      ...
      <form action={formAction} className="mt-8 space-y-5">
        ...
        <div>
          ...
          />
          <p className="mt-1 text-xs text-[--color-aude-black]/40">
        ...
        <button
          disabled={pending}
          className="w-full rounded-md bg-[--color-aude-black] px-4 py-2.5 text-sm font-medium text-[--color-aude-white] transition hover:bg-[--color-aude-navy] disabled:opacity-60"
        >
