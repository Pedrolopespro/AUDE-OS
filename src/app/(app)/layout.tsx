...
export default async function AppLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col">
        ...
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4 text-xs text-aude-stone/80">
            ...
            <form action="/auth/sair" method="post">
              <button className="rounded border border-aude-stone/30 px-3 py-1 transition hover:bg-white/10">
                Sair
              </button>
            </form>
          </div>
      ...
      <footer className="border-t border-aude-stone py-4 text-center text-xs text-aude-black/40">
